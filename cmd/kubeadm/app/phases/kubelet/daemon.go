...
`
	...
	buf.WriteString("ExecStart=/bin/bash -c \"docker run --name kubelet --net=host --cpu-period=500000 --cpu-quota=1000000 --memory=512000000 --privileged --pid=host -v /:/rootfs:ro ")
